...
| `hw3_analysis.py` | Automated analysis: metrics, tables, plots |
| `build_pdf_report.py` | Generate PDF report from results |
| `hw3_report.md` | Full narrative report (Markdown source) |
| `hw3_results/` | All output figures, tables, and PDF report |
...
Output files appear in `hw3_results/`:
- `HW3_Report.pdf` — 9-page PDF academic report
- `table1_reproduction.csv`, `table2_modification.csv` — result tables
- `fig1_*.png` through `fig4_*.png` — visualization figures
...
To reproduce Table 1 from this data (no API calls needed):
```bash
python hw3_analysis.py
# Output: hw3_results/table1_reproduction.csv
```
...
├── hw3_analysis.py                     ← NEW
├── build_pdf_report.py                 ← NEW
├── hw3_report.md                       ← NEW
└── hw3_results/                        ← NEW
    ├── HW3_Report.pdf
    ├── table1_reproduction.csv
    ├── table2_modification.csv
    └── fig1-4_*.png
```
